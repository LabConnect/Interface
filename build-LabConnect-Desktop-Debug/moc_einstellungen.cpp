...
#include "../LabConnect/einstellungen.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Einstellungen_t, stringdata) + ofs \
...
const QMetaObject Einstellungen::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Einstellungen.data,
      qt_meta_data_Einstellungen,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Einstellungen.stringdata))
        return static_cast<void*>(const_cast< Einstellungen*>(this));
